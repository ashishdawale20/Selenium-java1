...
public class HTMLReportGenerator {
	...
	public static void main(String[] args) throws UnknownHostException {
			...
			TestSuiteStart("D:\\HTMLReport\\manish.html", "ejagruti");
			TestCaseStart("TEST CASE 1", "this is test case description 1");
			StepDetails("pass", "STEP 1.1", "this is step details 1");
			StepDetails("fail", "STEP 1.2", "this is step details 2");
			TestCaseEnd();
			System.out.println("gbghghgdhgdhgd");
			TestCaseStart("TEST CASE 2", "this is test case description 2 ");
			StepDetails("pass", "STEP 2.1", "this is step details1");
			StepDetails("fail", "STEP 2.2", "this is step details2");
			StepDetails("fail", "STEP 2.3", "this is step details3");
			StepDetails("pass", "STEP 2.4", "this is step details4");
			TestCaseEnd();
			System.out.println("jsvjnm vhsbdhvjbnv");
			TestSuiteEnd();  
